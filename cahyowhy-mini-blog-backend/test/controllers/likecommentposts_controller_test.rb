...
class LikecommentpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create likecommentpost" do
    assert_difference('Likecommentpost.count') do
      post likecommentposts_url, params: { likecommentpost: { commentpost_id: @likecommentpost.commentpost_id, user_id: @likecommentpost.user_id } }, as: :json
    end
  ...
  test "should update likecommentpost" do
    patch likecommentpost_url(@likecommentpost), params: { likecommentpost: { commentpost_id: @likecommentpost.commentpost_id, user_id: @likecommentpost.user_id } }, as: :json
    assert_response 200
  end
