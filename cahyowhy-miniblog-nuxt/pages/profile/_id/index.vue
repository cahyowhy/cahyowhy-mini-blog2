<template>
  <div>
    <div class="status-wrapper">
      <status-item :key="status.id" v-for="status in $store.state.statuses.statusItems" :username="status.user.username" imageProfile="status.user.imageurl" :statushtml="status.statushtml" :statusText="status.statustext" :statusId="status.id" :statusImages="status.imagestatuses" :likestatuses="status.likestatuses" :commentstatuses="status.commentstatuses" />
    </div>
