        ...
        <nuxt-link :to="{name: 'post-detail-id', params:{id: 156}}">
          ...
          <div class="col-sm-4 sm-margin-b-60">
            <div class="margin-b-30">
              ...
              <p class="promo-block-text">Menulis dimari</p>
            </div>
          ...
          <div class="col-sm-8">
            <div class="promo-block-img-wrap">
              <img class="promo-block-img img-responsive" src="~assets/img/mockup/avatar-01.png" align="Avatar">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-7">
            <div class="section-seperator margin-b-50">
              <div class="margin-b-50">
                <div class="margin-b-30">
                  <h2>About Me</h2>
                  <p>I'm Alisa Portman, orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
            ...
            <div class="col-md-3 col-sm-6 md-margin-b-4">
              <div class="service bg-color-base wow zoomIn" data-height="height" data-wow-duration=".3"
                ...
                <div class="service-info">
                  ...
                  <p class="color-white margin-b-5">Lorem ipsum dolor amet consectetur ut consequat siad esqudiat
                    dolor</p>
                </div>
                <a href="#" class="content-wrapper-link"></a>
              </div>
    ...
    <div id="work">
      <div class="container content-lg">
        <div class="row margin-b-40">
          <div class="col-sm-6">
            <h2>Bacaan terfavorit</h2>
            <p>menu bacaan favorit hari ini</p>
          </div>
        </div>
        <div class="row">
        ...
        <div class="btn-wrp">
          <nuxt-link class="btn btn-primary btn-lg" to="/post">
            see all
          </nuxt-link>
        </div>
      </div>
